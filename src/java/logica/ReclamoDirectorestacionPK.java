 ...
 */
@Embeddable
public class ReclamoDirectorestacionPK implements Serializable {
    ...
    public ReclamoDirectorestacionPK() {
    }

    public ReclamoDirectorestacionPK(String ticketReclamo, String identificacionDirectorestacion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReclamoDirectorestacionPK)) {
            return false;
        }
        ReclamoDirectorestacionPK other = (ReclamoDirectorestacionPK) object;
    ...
    public String toString() {
        return "logica.ReclamoDirectorestacionPK[ ticketReclamo=" + ticketReclamo + ", identificacionDirectorestacion=" + identificacionDirectorestacion + " ]";
    }
